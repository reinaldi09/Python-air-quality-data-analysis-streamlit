...
# # Konversi kolom 'date' ke datetime dan atur sebagai indeks
...
# st.markdown("Grafik menunjukkan tren musiman dari PM2.5 dan PM10 sepanjang tahun. Pola musiman dapat diamati dengan puncak pada bulan tertentu.")

# # 2. Hubungan NO2 dan SO2 dengan suhu (TEMP)
...
# # 3. Hubungan kecepatan angin (WSPM) dan polutan (PM2.5, PM10, CO)
...
# ax[0].set_xlabel("Kecepatan Angin (m/s)")
...
# ax[1].set_xlabel("Kecepatan Angin (m/s)")
...
# ax[2].set_xlabel("Kecepatan Angin (m/s)")
# ax[2].set_ylabel("CO (mg/m³)")
